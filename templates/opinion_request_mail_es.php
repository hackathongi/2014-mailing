<?php
$html_mail['subject'] = 'Valora tu experiencia';
...
<p style="font-family:Arial, Helvetica, sans-serif;font-size:13px;color:#666;">Muchas gracias por comprar en <strong>' . $po['shop']['name'] . '</strong>.
nos gustaría saber cómo valoras la experiencia que ha tenido en su compra on-line!</p> 
...
<p style="font-family:Arial, Helvetica, sans-serif;font-size:13px;color:#666;">Gracias por su confianza,</p>'
. $shop['firma_html'] . '
</div>
